...
public class EndorsementService {
    ...
    @Inject
    public EndorsementService(ResourceLoader resourceLoader, UserDao userDao, EmailService emailService, AppProperties appProperties) {
    ...
    private void checkProfanity(String input) {
        ...
        if (!badWords.isEmpty()) {
            throw new SoftException("Please remove these words: " + StringUtil.join(",", badWords));
        }
    }
